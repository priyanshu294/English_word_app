...
public class ColorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      final   ArrayList<Word> words = new ArrayList<Word>();
        ...
        words.add(new Word("dusty yellow",R.drawable.color_dusty_yellow,R.raw.dusty_yellow));
        words.add(new Word("mustard yellow",R.drawable.color_mustard_yellow,R.raw.mustard_yellow));
